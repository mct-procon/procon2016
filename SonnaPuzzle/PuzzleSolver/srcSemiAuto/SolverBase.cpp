...
void SolverBase::input(string filename, double dist_error, double angle_error)
{
	...
	//パラメータの設定
	parameter.dist_error = dist_error;
	parameter.angle_error = angle_error;
	parameter.dist_error_waku = dist_error;
	//parameter.angle_error_tigit = angle_error * 0.25;
	//parameter.dist_error_tigit = dist_error * 0.25;
